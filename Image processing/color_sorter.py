...
def main():
    ...
    success, clusters = pcl.get_cluster_positions(ref_frame="vx300s/base_link", sort_axis="y", reverse=True)
    ...
    for cluster in clusters:
        ...
        if (clr == "red"):
            ...
            bot.arm.set_ee_pose_components(x=0.4, y=0.24, z=0.04)
        elif (clr == "dark_blue"):
            bot.arm.set_ee_pose_components(x=0.4, y=-0.24, z=0.04)
        elif (clr == "blue"):
...
def color_compare(rgb):
    ...
    #blue-0.4455, 0.482
    #dark blue-0.55,0.57
    if h < 0.1565: color = "red"
    elif 0.51 < h < 0.58: color = "dark_blue"
    elif 0.1 < h < 0.15: color = "yellow"
    elif 0.21 < h < 0.25: color = "green"
    elif 0.43 < h < 0.492: color = "blue"
